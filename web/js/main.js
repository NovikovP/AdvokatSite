(function($){
        ...
        var siteSlider = $('.item__preview-slider');
        ...
        customTrigger( '.thumb-nav .nav-right', '.thumb-nav .nav-left', siteSlider);
         ...
         */
        $('http://matronet.com/law/img.svg').each(function(){
            var $img = $(this);
